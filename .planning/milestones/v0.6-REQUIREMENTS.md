# Requirements Archive: v0.6 Spec conformance — dtypes + CV/geometry/provenance

**Archived:** 2026-06-06
**Status:** SHIPPED — 21/21 requirements delivered + tested (335 tests green). Audit PASSED.

For current requirements, see the next milestone's `.planning/REQUIREMENTS.md` (created by /gsd:new-milestone).
