...
- [x] **Phase 17: cv_list file-level CV declaration** — forward declares every CV (MS/IMS/UO) referenced in the archive (spec Edit 2).
...
- [x] **Phase 19: source_files[] provenance** — forward records input `.imzML`/`.ibd` provenance reusing the integrity preflight's UUID/checksum (spec Edit 10).
- [x] **Phase 20: Optical image auto-discovery & auto-embed** — forward follows the source imzML's `IMS:1006008` reference and auto-embeds the optical image, capturing descriptive CV attrs.
- [x] **Phase 21: Reverse optical image export** — reverse writes embedded image members back out + re-emits `IMS:1006008`, restoring forward↔reverse optical symmetry.
...
| 21. Reverse optical image export | v0.6 | 3/3 | Complete   | 2026-06-06 |
