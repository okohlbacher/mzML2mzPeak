...
- [x] 15-03-PLAN.md — Repeatable forward `--image` (reverse-rejected) + convert() terminal-seam import loop (images/image_NNNN.tiff Other members) + fixture + end-to-end tests (IMG-01, IMG-02, IMG-03, IMG-04).
